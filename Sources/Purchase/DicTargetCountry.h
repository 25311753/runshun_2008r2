...
#ifndef DicTargetCountryH
#define DicTargetCountryH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <jpeg.hpp>
//---------------------------------------------------------------------------
class TDicTargetCountryForm : public TForm
{
...
public:		// User declarations
	int m_nAuthor;
        ...
        void Row2Editor();
        void ResetCtrl();
        __fastcall TDicTargetCountryForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TDicTargetCountryForm *DicTargetCountryForm;
//---------------------------------------------------------------------------
#endif
