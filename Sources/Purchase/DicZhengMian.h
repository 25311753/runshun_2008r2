...
#ifndef DicZhengMianH
#define DicZhengMianH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <jpeg.hpp>
//---------------------------------------------------------------------------
class TDicZhengMianForm : public TForm
{
...
public:		// User declarations
	int m_nAuthor;
        ...
        void Row2Editor();
        void ResetCtrl();
        __fastcall TDicZhengMianForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TDicZhengMianForm *DicZhengMianForm;
//---------------------------------------------------------------------------
#endif
