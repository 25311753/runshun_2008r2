...
//---------------------------------------------------------------------------
class TRawBookFactoryListForm : public TForm
{
...
public:		// User declarations
	__fastcall TRawBookFactoryListForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TRawBookFactoryListForm *RawBookFactoryListForm;
//---------------------------------------------------------------------------
#endif
