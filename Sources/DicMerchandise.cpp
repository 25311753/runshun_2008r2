...
void TDicMerchandiseForm::Row2Editor()
{
  ...
  edtWeightPercent->Text = pItem->SubItems->Strings[5].IsEmpty()?AnsiString(""):pItem->SubItems->Strings[5];
locateCbbByValue(cbbCrName1,  pItem->SubItems->Strings[6].IsEmpty()?AnsiString(""):pItem->SubItems->Strings[6]);
edtUnitPrice1->Text = pItem->SubItems->Strings[7].IsEmpty()?AnsiString(""):pItem->SubItems->Strings[7];
locateCbbByValue(cbbCrName2,  pItem->SubItems->Strings[8].IsEmpty()?AnsiString(""):pItem->SubItems->Strings[8]);
edtUnitPrice2->Text = pItem->SubItems->Strings[9].IsEmpty()?AnsiString(""):pItem->SubItems->Strings[9];
...
strcpy(strUnitPrice2,sp2.c_str());
  ...
  {
    case EN_ADDNEW:
      sprintf(strSQL,"insert into merchandise(no,mcode,mname,spec,firstmeasunit,secondmeasunit,weight_percent,crname1,unitprice1,crname2,unitprice2) \
